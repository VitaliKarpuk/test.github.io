...
$message = "Ваше имя : ".$_POST[ddd]."<br>";//присвоить переменной значение, полученное из формы name=name
$message .= "Номер телефона: ".$_POST[dsd]."<br>"; //полученное из формы name=phone
